// ==UserScript==
// @name         B2I
// @namespace    YogCrafteR
// @version      1.0
// @description  Plugins pour Jerevise.net B2I
// @author       YogFx / Xavier Amichot Spriet
// @match        http://www.eren.lautre.net/portesdelaforet/jeux/b2i/index.php
// @require      http://chezsoiprestations.tk/js/b2i.js
// @grant        none
// @run-at       document-start
// @maj          http://chezsoiprestations.tk/js/b2i.js
// ==/UserScript==
...
setTimeout(function() {
    ...
    $( "#canvas" ).after( "<?php><div style='background-color: #000000; -moz-opacity: 0.4; -khtml-opacity: 0.4; opacity: 1.0; border-radius: 50px 50px 50px 50px; filter: alpha(opacity=100); zoom: 1; width: 205px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: #ffffff; padding: 5px; font-family: Ubuntu;'> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a>YogBots v1.0</a></div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>Prenom: <input type=text/> <br>Nom: <input type=text/> <br> Se connecter: <input type:submit/></div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br><a>A</a> - Move To Mouse: <a id='ismoveToMouse' >On</a> </div> <div style='color:#ffffff; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br><a>D</a> - Stop Movement: <a id='isStopMove' >Off</a> </div> <a><br>E</a> - Split bots <a><br>R</a> - Eject mass" );
